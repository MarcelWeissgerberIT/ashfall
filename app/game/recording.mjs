...
export function recordGame(canvas,audioStream,onDone,onError){
 if(typeof MediaRecorder==='undefined'||!canvas?.captureStream)throw Error('Recording is unavailable in this browser.');
