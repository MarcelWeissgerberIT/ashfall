...
export default function CharacterPreview({game}:{game:any}) {
  ...
  useEffect(()=>{
    ...
    scene.add(new THREE.HemisphereLight(0xe5ecda,0x645349,2.2));const key=new THREE.DirectionalLight(0xffe5d3,2.6);key.position.set(-2,4,3);scene.add(key);const rim=new THREE.DirectionalLight(0x87b7c0,2);rim.position.set(2,2,-2);scene.add(rim);
