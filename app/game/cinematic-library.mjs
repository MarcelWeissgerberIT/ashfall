...
export const CINEMATICS=[
 {id:'intro',title:'A promise to Koda',deTitle:'Ein Versprechen an Koda',chapter:1,poster:'/images/openart/checkpoint.webp',src:'/video/ashfall-prologue-en.mp4'},
 {id:'evac',title:'Flight to Haven',deTitle:'Flug nach Haven',chapter:3,poster:'/images/openart/checkpoint.webp',src:'/video/ashfall-evac-haven.mp4'},
 ...[
...
export function seenCinematics(storage,game={}){
 ...
 for(const film of CINEMATICS)if(film.id!=='intro'&&(Math.max(game.level??0,game.unlocked??0)>=film.chapter||(game.mode==='won'&&film.chapter===30)))seen.push(film.id);
