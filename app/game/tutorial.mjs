export const TUTORIAL_STEPS = [
  ...
  {id:'pack',title:'Know your equipment',task:'Open your inventory, inspect your gear, then close it.',body:'Press I or use the backpack button. Select an item to equip, use, or drop it. Hand, body, and head slots show your loadout. Only your held weapon deals its listed damage; only worn armor protects you. Find a jacket and helmet near the start. You can carry 14 kg. Dropped items stay where you leave them. Opening the backpack pauses the mission; close it with I, Escape, or the close button.',control:'I · OPEN / CLOSE BACKPACK'},
  ...
  {id:'fuse',title:'Search the guard crate',task:'Find the Fuse in the marked guard crate.',body:'The bunker has no power. First, click the guard crate in the northwest corner. Containers are searched automatically when you arrive. If your backpack is too heavy, open it, drop some salvage, then search the crate again. Stay alert as you move across the checkpoint.',control:'CLICK A CONTAINER · SEARCH'},
  {id:'fuel',title:'Find fuel in the wreck',task:'Search the car trunk for a Fuel canister.',body:'The generator also needs diesel. Click the marked car trunk in the southeast. Take the Fuel and keep it with the Fuse. The crate or trunk keeps anything that did not fit in your backpack, so you can come back after making space.',control:'FUSE + FUEL · RESTORE POWER'},
...
export function updateTutorial(game) {
  ...
  if(game.inventoryOpen||game.mode!=='playing')return;
